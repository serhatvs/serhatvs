...
def spotify_card() -> str:
  ...
  <text x="228" y="92" class="h" fill="#F5F6F7">Arkhino_DEV</text>
  <text x="470" y="92" class="m" fill="#FFD77A">Spotify Profile</text>
  <text x="228" y="124" class="p" fill="#C59DD9">Coding sessions, late-night builds, and synth-heavy focus loops</text>
  <text x="228" y="152" class="m" fill="#C1C4C8">Static profile card with a direct jump to the Spotify page</text>

  <rect x="228" y="168" width="196" height="30" rx="15" fill="#E6A520" opacity="0.96"/>
  <text x="326" y="187" text-anchor="middle" class="chip" fill="#2B0D3E">OPEN ON SPOTIFY</text>
